...
const ERROR_FIELDS = ["code", "error", "message", "detail", "reason", "data", "cause"];
function errorStrings(value, seen, depth) {
    ...
    if (value instanceof Error)
        return [value.message, ...errorStrings(value.cause, seen, depth + 1)];
    if (Array.isArray(value))
        return value.flatMap((item) => errorStrings(item, seen, depth + 1));
...
var installLsfgPlugin$1 = "Install Little Yellow Duck / LSFG-VK";
var installFsr4Plugin$1 = "Install FSR4 / Decky-Framegen";
...
var trainerCompatLatestHint$1 = "For newer games/trainers; verify per game.";
var trainerCompatOlderHint$1 = "For older games/trainers.";
...
var trainerCompatLatestHint = "适合新游戏／新修改器，仍应以具体游戏测试为准。";
var trainerCompatOlderHint = "适合老游戏／老修改器。";
